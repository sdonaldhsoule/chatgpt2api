...
const imageModelOptions: Array<{ value: ImageModel; label: string }> = [
  { value: "auto", label: "自动" },
              ...
              <div className="flex items-end justify-between gap-2 sm:gap-3">
                <div className="hide-scrollbar flex min-w-0 flex-1 flex-nowrap items-center gap-1.5 overflow-x-auto pb-0.5 sm:flex-wrap sm:gap-3 sm:overflow-visible sm:pb-0">
                  ...
                  <Select value={model} onValueChange={(value) => onModelChange(value as ImageModel)}>
                    <SelectTrigger className="h-9 w-[132px] shrink-0 rounded-full border-stone-200 bg-white px-3 text-xs font-medium text-stone-700 shadow-none sm:h-10 sm:w-[156px] sm:px-4 sm:text-sm">
